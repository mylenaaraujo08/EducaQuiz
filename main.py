...
class HistoryQuizScreen(Screen):
    ...
    def reset_quiz(self):
        self.questions = [
            ...
            {
                "question": "Questão 3 (UNICAMP) O que foi o Manifesto Comunista e quem o escreveu?",
                "options": ["a) Documento que defende a abolição da escravatura, escrito por Karl Marx e Friedrich Engels", "b) Documento que critica o capitalismo, escrito por Karl Marx e Friedrich Engels", "c) Documento que apoia a monarquia absoluta, escrito por Thomas Hobbes e John Locke", "d) Documento sobre direitos humanos, escrito por Jean-Jacques Rousseau", "e) Documento que defende o liberalismo econômico, escrito por Adam Smith"],
                "answer": "b) Documento que critica o capitalismo, escrito por Karl Marx e Friedrich Engels"
            },
            {
                "question": "Questão 4 (UERJ) Qual foi o principal objetivo da Revolução Industrial?",
            ...
            {
                "question": "Questão 5 (UEG) A Primeira Guerra Mundial foi desencadeada principalmente por:",
